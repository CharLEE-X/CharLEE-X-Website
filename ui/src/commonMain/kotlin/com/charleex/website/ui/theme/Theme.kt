...
private val LightColorPalette = CharLEEXColors(
    brand = Shadow5,
...
private val DarkColorPalette = CharLEEXColors(
    brand = Shadow1,
...
@Composable
internal fun CharLEEXTheme(
    darkTheme: Boolean = isSystemInDarkTheme(),
    content: @Composable () -> Unit
) {
    val colors = if (darkTheme) DarkColorPalette else LightColorPalette

    ProvideCharLEEXColors(colors) {
        MaterialTheme(
...
internal object CharLEEXTheme {
    val colors: CharLEEXColors
        @Composable
        get() = LocalJetsnackColors.current
}

@Stable
internal class CharLEEXColors(
    ...
    fun update(other: CharLEEXColors) {
    ...
    fun copy(): CharLEEXColors = CharLEEXColors(
...
@Composable
internal fun ProvideCharLEEXColors(
    colors: CharLEEXColors,
    content: @Composable () -> Unit
) {
...
private val LocalJetsnackColors = staticCompositionLocalOf<CharLEEXColors> {
    error("No JetsnackColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [CharLEEXTheme.colors].
 */
